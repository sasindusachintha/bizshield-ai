/**
 * prefs.js — BizShield-AI Global Preferences
 ...
 *
 * Load order: api.js → prefs.js → page-specific JS
 */

// ── Currency helpers ────────────────────────────────────
const BS_CURRENCY_SYMBOLS = { USD: '$', LKR: 'Rs.', EUR: '\u20ac', GBP: '\u00a3', INR: '\u20b9' };
...
function getBSCurrencySymbol(currency) {
    return BS_CURRENCY_SYMBOLS[currency || getBSCurrency()] || currency || getBSCurrency();
}
...
const SI_TRANSLATIONS = {
    ...
    'Tools': 'මෙවලම්',
    // Dashboard cards
    'Generate Ideas': 'අදහස් ජනනය',
    'Analyze Idea': 'අදහස විශ්ලේෂණය',
    ...
    'Creating kit...': 'කට්ටලය සකසමින්...',
    'Creating kit…': 'කට්ටලය සකසමින්...',
    'Crafting your marketing content kit...': 'ඔබේ අලෙවිකරණ අන්තර්ගත කට්ටලය සකසමින්...',
    'Crafting your marketing content kit…': 'ඔබේ අලෙවිකරණ අන්තර්ගත කට්ටලය සකසමින්...',
    'Building plan...': 'සැලැස්ම ගොඩනගමින්...',
    'Building your personalised launch roadmap...': 'ඔබේ පුද්ගලීකරණය කළ ආරම්භක මාර්ග සිතියම ගොඩනගමින්...',
    ...
    'Slogans': 'සටන් පාඨ',
    'Social Captions': 'සමාජ මාධ්‍ය ශීර්ෂ පඏ',
    'No data available': 'දත්ත නොමැත',
    'Log in to save': 'සුරැකීමට ඇතුල් වන්න',
    'Saved': 'සුරැකිණි',
    'Saving': 'සුරකිමින්',
    'Please describe your business idea first.': 'කරුණාකර පළමුව ඔබේ ව්‍යාපාර අදහස විස්තර කරන්න.',
    'Total Projects': 'මුළු ව්‍යාපෘති',
    'Total Ideas': 'මුළු අදහස්',
    'Total Marketing Plans': 'මුළු අලෙවිකරණ සැලසුම්',
    'Total Marketing': 'මුළු අලෙවිකරණ',
    ...
    'Convening...': 'මණ්ඩලය කැඳවමින්...',
    'Crisis under review': 'සමාලෝචනය වන අර්බුදය',
    'Live Debate Panel': 'සජීවී මණ්ඩල සාකච්ඡාව',
    ...
    'Recovery Plan — Step by Step': 'ප්‍රතිසාධන සැලැස්ම — පියවරෙන් පියවර',
    'Immediate actions (24 hours)': 'ක්ෂණික ක්‍රියාමාර්ග (පැය 24)',
    'Short-term actions (7 days)': 'කෙටි කාලීන ක්‍රියාමාර්ග (දින 7)',
    'Long-term strategy (30 days)': 'දිගු කාලීන උපායමාර්ගය (දින 30)',
    'Save Outcome to Project': 'ප්‍රතිඵලය ව්‍යාපෘතියට සුරකින්න',
    'Please describe the crisis before convening the boardroom.': 'මණ්ඩල සාකච්ඡාව ආරම්භ කිරීමට පෙර කරුණාකර අර්බුදය විස්තර කරන්න.',
    'Please log in to run a boardroom debate.': 'මණ්ඩල සාකච්ඡාව ක්‍රියාත්මක කිරීමට කරුණාකර ඇතුල් වන්න.',
    'Run Boardroom Debate': 'මණ්ඩල වාද-විවාදය ක්‍රියාත්මක කරන්න',
    'Risk Score': 'අවදානම් ලකුණු',
    'Final Plan': 'අවසාන සැලැස්ම',
    'Aligned': 'එකඟතාව ඇත',
    'HIGH CONFLICT': 'ඉහළ මතභේදය',
    'The boardroom reached reasonable alignment — no high-conflict override was required.': 'මණ්ඩලය සාධාරණ එකඟතාවකට පැමිණියේය — ඉහළ මතභේද override එකක් අවශ්‍ය නොවීය.',
    'No recovery steps provided.': 'ප්‍රතිසාධන පියවර ලබාදී නැත.',
    'View in Project': 'ව්‍යාපෘතිය තුළ බලන්න',
    'Crisis outcome saved to your project.': 'අර්බුද ප්‍රතිඵලය ඔබේ ව්‍යාපෘතියට සුරැකිණි.',
    'Crisis Boardroom Outcome': 'අර්බුද මණ්ඩල ප්‍රතිඵලය',
    // Common labels
    ...
    'Interest': 'කැමැත්ත',
    'Analysis': 'විශ්ලේෂණය',
    'Business Plan': 'ව්‍යාපාර සැලැස්ම',
    'Marketing': 'අලෙවිකරණය',
    'Ideas': 'අදහස්',
    'Plan': 'සැලැස්ම',
    'Generate Business Ideas': 'ව්‍යාපාර අදහස් ජනනය කරන්න',
    'Build a Launch Plan': 'ආරම්භක සැලැස්මක් සාදන්න',
    'Business Analysis': 'ව්‍යාපාර විශ්ලේෂණය',
    'Crisis Mode — Boardroom Debate': 'අර්බුද ආකාරය — මණ්ඩල සාකච්ඡාව',
    'Your Skills': 'ඔබේ කුසලතා',
    'Interest / Niche': 'කැමැත්ත / විශේෂ ක්ෂේත්‍රය',
    ...
    'Currency / මුදල් ඒකකය': 'මුදල් ඒකකය',
    'System Preferences': 'පද්ධති මනාප',
    'Dark Mode': 'අඳුරු ආකාරය',
    'Context Memory': 'සන්දර්භ මතකය',
    'Settings saved!': 'සැකසුම් සුරැකිණි!',
    'Save Changes': 'වෙනස්කම් සුරකින්න',
    'New Project': 'නව ව්‍යාපෘතිය',
    'Project Title': 'ව්‍යාපෘති මාතෘකාව',
    'Ideas Generated': 'ජනනය කළ අදහස්',
    'Plans Created': 'සාදන ලද සැලසුම්',
    'Action Planning': 'ක්‍රියාකාරී සැලසුම්කරණය',
    'Marketing Automation': 'අලෙවිකරණ ස්වයංක්‍රීයකරණය',
    'Generate Your First Idea': 'ඔබේ පළමු අදහස ජනනය කරන්න',
    'Your Launch Roadmap': 'ඔබේ ආරම්භක මාර්ග සිතියම',
    ...
    '7-Day Sprint': 'දින 7 ක වේගවත් සැලැස්ම',
    '30-Day Milestones': 'දින 30 ඉලක්ක',
    ...
    'Breakdown': 'විස්තර',
    // Welcome
    'Your AI-powered startup toolkit. Pick a tool below to get started.': 'ඔබේ AI-බලගන්වන ආරම්භක මෙවලම් කට්ටලය.',
    'Your AI-powered business intelligence platform. Here\'s your current overview.': 'ඔබේ AI-ව්‍යාපාර බුද්ධි වේදිකාව.',
};
 ...
 * Only translates text nodes — never touches attributes or scripts.
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ① Update dashboard badges if present
    ...
    if (langBadge) langBadge.innerHTML = `<i class="fas fa-globe me-1"></i>${lang === 'si' ? repairSinhalaMojibake('සිං') : 'EN'}`;

    // ② Apply Sinhala if selected
    if (lang === 'si') {
        applySinhala();
    ...
    // ③ Patch all cost/currency strings rendered in the DOM after AI responses load
    if (currency !== 'USD') {
...
// ── Expose globally so page JS can call them ───────────
...
window.getBSCurrencySymbol = getBSCurrencySymbol;
