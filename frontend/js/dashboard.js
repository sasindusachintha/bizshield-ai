        ...
        <div class="row align-items-center g-4">
            ...
            <div class="col-md-5">
                ...
                <div class="row text-center g-2 small">
                    <div class="col-4">
                        <div class="text-success fw-bold">+${data.breakdown.demand_contribution}</div>
                        <div class="text-muted">Demand</div>
                    </div>
                    <div class="col-4">
                        <div class="text-success fw-bold">+${data.breakdown.skill_contribution}</div>
                        <div class="text-muted">Skill</div>
                    </div>
                    <div class="col-4">
                        <div class="text-danger fw-bold">−${data.breakdown.competition_penalty}</div>
